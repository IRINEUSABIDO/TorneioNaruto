...
def getNumTeams():
    ...
    try:
        ...
        if x>1:
            ...
            print("tem que ter pelo menos dois players")
            return getNumTeams()
    except:
        return getNumTeams()
...
def interfaceRun():
    ...
    print("randomizar times? (S/N): ", end='')

    if input() in ["s", "S"]:
        bracket.shuffle()
        print("Times randomizados")
    else:
        print("foi na ordem que botaram")
    ...
    for i in range(2,bracket.numRounds+1):
        ...
        while not updated:
            print("")
            print("Q para sair")
            sys.stdout.write(f"atualizar round {i} (nome dos vencedores): ")
    ...
    print("")
    print(bracket.rounds[-1][0]+" ganho")